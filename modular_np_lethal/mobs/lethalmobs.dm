...
/mob/living/basic/trooper/gakster/ranged/216razor
	name = "216 Razor"
	...
	maxHealth = 450
	health = 450
	loot = list(/obj/effect/mob_spawn/corpse/human/216razor, /obj/item/gun/ballistic/automatic/sol_grenade_launcher/evil, /obj/item/ammo_box/magazine/ammo_stack/c980/prefilled/fire)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/216razor
...
/mob/living/basic/trooper/gakster/ranged/391fathomer
	name = "391 Fathomer"
	desc = "Armed with a Ramu 6 gauge shotgun, this gakster is notorious for their potency in close quarters combat."
	maxHealth = 450
	health = 450
	loot = list(/obj/effect/mob_spawn/corpse/human/391fathomer, /obj/item/gun/ballistic/shotgun/ramu, /obj/item/ammo_box/magazine/ammo_stack/s6gauge/prefilled/longshot = 2)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/391fathomer
...
// 612 Chauchat : Drops a Seiba & ballistic shield alongside ammunition and a full set of type 3 armor, alongside a riot helmet
/mob/living/basic/trooper/gakster/ranged/612chauchat
	name = "612 Chauchat"
	...
	maxHealth = 600
	health = 600
	loot = list(/obj/effect/mob_spawn/corpse/human/612chauchat, /obj/item/shield/ballistic, /obj/item/gun/ballistic/automatic/seiba_smg, /obj/item/ammo_box/magazine/miecz = 2)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/612chauchat
...
/mob/living/basic/trooper/gakster/ranged/612chauchat/bullet_act(obj/projectile/projectile)
...
/mob/living/basic/trooper/gakster/melee/907prophet
	name = "907 Prophet"
	...
	maxHealth = 300
	health = 300
	loot = list(/obj/effect/mob_spawn/corpse/human/907prophet, /obj/item/dualsaber/red)
	mob_spawner = /obj/effect/mob_spawn/corpse/human/907prophet
	melee_damage_lower = 40
	melee_damage_upper = 40
	attack_verb_continuous = list("attacks", "slashes", "stabs", "slices", "tears", "lacerates", "rips", "dices", "cuts")
	attack_verb_simple = list("attack", "slash", "stab", "slice", "tear", "lacerate", "rip", "dice", "cut")
	attack_sound = 'sound/weapons/blade1.ogg'
	r_hand = /obj/item/dualsaber/red
	armour_penetration = 35
	light_range = 6
	light_power = 2.5
	light_color = COLOR_SOFT_RED

/mob/living/basic/trooper/gakster/melee/907prophet/bullet_act(obj/projectile/projectile)
