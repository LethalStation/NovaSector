...
/datum/species/plasmaman/create_pref_unique_perks()
	return list(
		...
		list(
			...
			SPECIES_PERK_DESC = "Plasmoids heal themselves and their host by consuming plasma, either from ingesting it in solid form, or from the gas that they breathe. Getting too damaged may cause them to eventually exhaust their internals!",
		),
		list(
			SPECIES_PERK_TYPE = SPECIES_POSITIVE_PERK,
