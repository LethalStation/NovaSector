...
/client/verb/ooc(msg as text)
	...
	if(SSplayer_ranks.is_donator(src))
		if(prefs.read_preference(/datum/preference/toggle/display_donator_status))
			keyname = "<font color='[prefs.read_preference(/datum/preference/color/ooc_color) || GLOB.normal_ooc_colour]'>[icon2html('modular_np_lethal/taskbar_icon/donator_chat_icon.dmi', world, "nova_logo")][keyname]</font>"
