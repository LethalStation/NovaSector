...
/datum/greyscale_config/New()
	...
	if(!(findtext(string_json_config, "code/datums/greyscale/json_configs/") != 1 || nova_gags_regex.Find(string_json_config) != 1 || findtext(string_json_config, "modular_np_lethal/lethal_GAGS/json_configs") != 1)) // LETHAL EDIT // NOVA EDIT CHANGE - ORIGINAL: if(findtext(string_json_config, "code/datums/greyscale/json_configs/") != 1)
